...
PROVENANCE: copied VERBATIM from surplus_value_model/src/metrica_io.py on 2026-07-30.
Do not diverge silently — if this file needs changes, either (a) change it upstream and
re-copy, or (b) record the divergence here and in NOTES.md. Copied rather than imported
deliberately (space_analysis/NOTES.md "Reuse policy"): two small frozen files beat a
path hack or packaging the other project at prototype scale.
